...
const FIELD_LABELS: Record<string, string> = {
  firstname: "First Name",          middlename: "Middle Name",    surname: "Last Name",   suffix: "Suffix",
...
function generateSuggestions(oldData: any, newData: any): string[] {
  ...
  const personalKeys = [
    "firstname","middlename","surname","suffix","birthdate","birthplace","sex","civil_status","blood_type","height","weight",
  ...
  const nameFields    = ["firstname","middlename","surname","suffix"]
